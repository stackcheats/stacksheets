...
short: Configure Okta as a Third-Party Keymanager for WSO2 API Manager
medium: https://medium.com/@athiththan11/wso2-api-manager-okta-af7b74ba9a3f
...
![Okta Authorization Server](assets/okta-authorization-server-navigation.png)
...
![Default Authorization Server](assets/authorization-server-list.png)
...
![Create Defualt Scope](assets/create-default-scope.png)

Next, select the `Tokens` tab to create a new API Token for WSO2 API Manager to communicate with our Okta server.

![Authorization Server Tokens](assets/authorization-server-tokens.png)
...
![Authorization Server Token List](assets/authorization-server-token-list.png)
...
![Okta Application](assets/add-okta-application.png)
...
![Create Okta Application](assets/create-okta-application.gif)
...
<Reference 
    title="APIM Keymanager Okta"
    description="Okta key-manager implementation for WSO2 API Manager"
    hyperlink="https://github.com/athiththan11/apim-keymanager-okta"
/>
...
![Add Store Application](assets/store-add-application.png)

Give inputs to all required fields and click on Add to create the Application.

![Store Application](assets/store-application-create.png)
...
![Production Key Generation](assets/production-key-generate.png)
...
![Production Keys](assets/store-production-keys.png)
...
![Okta Demo Application](assets/okta-demo-application.png)
